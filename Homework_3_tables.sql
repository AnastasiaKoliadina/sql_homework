...
/*
Задание № 1. Напишите запрос, который вывел бы таблицу со столбцами в следующем порядке: city, sname,
...
/* 
Задание № 2. Напишите команду SELECT, которая вывела бы оценку(rating), сопровождаемую именем
...
SELECT MIN(amt) AS min_sum
  FROM orders;
  
  
 /*
 Задание № 7. Напишите запрос к таблице “Заказчики”, который может показать всех заказчиков, у которых
...
*/
  ...
  SELECT salary
    FROM staff
ORDER BY salary DESC; -- на убывание--

  SELECT salary
    FROM staff
ORDER BY salary; -- на возрастание--


/*
Задание № 2. Отсортируйте по возрастанию поле “Зарплата”
